      ...
      <div className="bg-gray-900 rounded-2xl max-w-md w-full text-center border border-gray-700 relative">
        ...
        <div className="px-6 pb-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 ${
                  selectedPlan === 'basic' ? 'bg-[#E50914]' : 'bg-gray-700'
                }`}>
                  <Star className={`w-5 h-5 ${selectedPlan === 'basic' ? 'text-white' : 'text-[#E50914]'}`} />
                </div>
                <div className="text-left">
                  <h3 className={`font-semibold ${selectedPlan === 'basic' ? 'text-[#E50914]' : 'text-white'}`}>
                    Basic Premium
                  </h3>
              ...
              <div className={selectedPlan === 'basic' ? 'text-[#E50914]' : 'text-gray-400'}>
                {selectedPlan === 'basic' ? (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 ${
                  selectedPlan === 'standard' ? 'bg-[#E50914]' : 'bg-gray-700'
                }`}>
                  <Star className={`w-5 h-5 ${selectedPlan === 'standard' ? 'text-white' : 'text-[#E50914]'}`} />
                </div>
                <div className="text-left">
                  <h3 className={`font-semibold ${selectedPlan === 'standard' ? 'text-[#E50914]' : 'text-white'}`}>
                    Standard Premium
                  </h3>
                  ...
                  {selectedPlan === 'standard' && (
                    <span className="bg-[#E50914] text-white text-xs font-bold px-2 py-1 rounded mt-1 inline-block">
                      RECOMMENDED
                    </span>
                  )}
                </div>
              </div>
              <div className={selectedPlan === 'standard' ? 'text-[#E50914]' : 'text-gray-400'}>
                {selectedPlan === 'standard' ? (
                  <Check className="w-5 h-5" />
                ) : (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-6 pb-8">
          <Button
            ...
            className="w-full bg-[#E50914] hover:bg-[#b80710] text-white h-12 font-semibold rounded-lg"
          >
