      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="p-6 text-center bg-white rounded-lg shadow hover:shadow-orange-400 transition-shadow">
            <div className="h-8 w-8 text-[#E50914] mx-auto mb-3 text-3xl">⭐</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto p-8 bg-white rounded-lg shadow">
            ...
            <form className="space-y-6">
              ...
              <button type="submit" className="w-full px-4 py-3 rounded bg-[#E50914] hover:bg-[#b80710] text-white font-semibold text-lg transition">
            ...
            <div className="text-center mt-6">
              <p className="text-xs text-gray-500">
                ...
                <a href="/privacy-policy" className="text-[#E50914] hover:underline">
                  Privacy Policy
                </a>
