  ...
  return (
    <main className="min-h-screen bg-black flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="flex items-center justify-center gap-4 mt-2">
        <a href="https://wa.me/256780846800" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 underline hover:text-[#E50914] transition-colors">
