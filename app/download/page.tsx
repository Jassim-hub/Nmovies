...
export default function DownloadPage() {
  return (
    <main className="min-h-screen bg-black flex flex-col items-center justify-center px-4 py-16">
      <DownloadLogo />
      <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 text-center">Download NicholMoviesUg App</h1>
      ...
      <div className="flex items-center justify-center gap-4 mt-2">
        <a href="https://wa.me/256757588585" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 underline hover:text-[#E50914] transition-colors">
          <img src="/whatsapp-brands-solid-full.svg" alt="WhatsApp" className="w-5 h-5 inline-block" />
          WhatsApp Support
        </a>
        <a href="https://t.me/256757588585" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 underline hover:text-blue-400 transition-colors">
