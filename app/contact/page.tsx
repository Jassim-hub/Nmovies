        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="p-8 bg-white rounded-lg shadow">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    id="name"
                    name="name"
                    className="block w-full rounded border border-orange-200 px-3 py-2 text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E50914] focus:border-[#E50914] transition"
              ...
              <button type="submit" className="w-full px-4 py-3 rounded bg-[#E50914] hover:bg-[#b80710] text-white font-semibold text-lg flex items-center justify-center gap-2 transition">
              ...
              <div className="space-y-6">
                <div className="p-6 bg-white rounded-lg shadow hover:shadow-orange-400 transition-shadow">
                  <div className="flex items-start gap-4">
                    <span className="text-2xl text-[#E50914] mt-1">📧</span>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <a href="#" className="text-[#E50914] hover:underline">Twitter</a>
                        <span className="text-gray-400">•</span>
                        <a href="#" className="text-[#E50914] hover:underline">Instagram</a>
                        <span className="text-gray-400">•</span>
                        <a href="#" className="text-[#E50914] hover:underline">Facebook</a>
                      </div>
                    </div>
                  </div>
                </div>
